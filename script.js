...
let pages = [
    ...
    {description: 'På veien møter du på en postmann. Han vinker med en konvolutt i hånda.', choice1: 'Stoppe opp (+100G)', choice1Chosen: 'Postmannen informerer deg om at han har et brev til en person han hater, og at han heller gir deg den og mister jobben sin enn å levere den til riktig person. <br/> i brevet finner du penger. Du kjører videre.', choice2: 'Kjør over ham (+100G & +10EXP)', choice1ChosenGainCoin: true, choice2Chosen: 'Du kjører over postmannen. Mens du går gjennom posten han hadde igjen, bare ett brev, puster han ut et siste utsagn: <br/> "Hvorfor gjor-" men du kjører videre før han blir ferdig. Har ikke tid til det.', choice2ChosenGainCoin: true},
